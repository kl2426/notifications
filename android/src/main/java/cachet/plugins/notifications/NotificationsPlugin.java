...
public class NotificationsPlugin implements EventChannel.StreamHandler {
    ...
    class NotificationReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String packageText = intent.getStringExtra(NotificationListener.NOTIFICATION_PACKAGE_TEXT);
            String msg = "{\"title\":\"" + packageTitle + "\",\"package\":\"" + packageName + "\",\"text\":\"" + packageText + "\",\"textLines\":\"\"}";
